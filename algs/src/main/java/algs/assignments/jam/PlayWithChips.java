...
class Solution {
    public int minCostToMoveChips(int[] chips) {
        ...
        // [1,2,2,2,4,1,5] - it is easier to move all chips is 
        // odd positions, than those who is in even positions 
        // since odd positions are less than even.
        for (int c : chips)
            o = (c%2 == 0) ? o : o+1;
        
        return Math.min(o, chips.length-o);
    }
}