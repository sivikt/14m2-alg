 ...
 *     Hint (digraph): compute the strong components and look at the kernel DAG (the digraph that results when you
 *                     contract each strong component to a single vertex).
 * """
 */
