...
if __name__ == '__main__':
    ...
    assert Solution().isSubsequence('', 'abds')
    assert Solution().isSubsequence('a', 'abds')
    assert Solution().isSubsequence('as', 'abds')
    assert not Solution().isSubsequence('assss', 'abds')
    assert not Solution().isSubsequence('asss', 'abds')
